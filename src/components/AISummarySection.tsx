  ...
  return <section className="flex-1 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-8">
      <div className="max-w-2xl text-center space-y-4 w-full">
        <h1 className="font-display font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-foreground leading-tight">
          <span className="block text-secondary dark:text-foreground mt-2 text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-bold">STEELERS</span>
        </h1>
        
        <div className="max-w-sm sm:max-w-md mx-auto w-full">
          <div className="grid grid-cols-1 gap-3 mt-8 sm:mt-14">
            {/* Game 1 */}
            <div className="flex items-center justify-between bg-card/50 rounded-lg px-3 sm:px-4 py-3 border border-border/20">
